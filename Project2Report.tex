...
For my FGSM attack, it fooled the model by having it classify both the grass and dandelion images as grass. This is because [,2] was close to 1 while [,1] was 0 for both the grass and dandelion images. [,2] refers to grass probability while [,1] refers to dandelion probability. Therefore, my FGSM attack fooled the model into classifying both the grass and dandelion images as grass.} 
